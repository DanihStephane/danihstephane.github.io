const translations = {
  "fr": {
    ...
    "second_box_description": "Amélioration de l'application web de gestion des données afin d'améliorer l'efficacité et la précision de la collecte statistique. Ce projet vise à intégrer des fonctionnalités avancées pour faciliter la saisie, le traitement et l'analyse des données, tout en garantissant une interface utilisateur intuitive et conviviale.",
    "specifications" : "Spécifications",
    "specifications_descriptions": "Gestion de projet pour la collecte : base de données, interface avec l'écosystème client, encaissement des chèques, ciblage marketing, et datavisualisation.",
    ...
    "education_first_box_title": "Université Côte d'Azur",
    "education_first_box_description": "Ingénierie informatique. Parcours Mobiquité, Big Data et intégration de Systèmes (MBDS)",
    
    "license":"Licence",
   "education_second_box_title": "IT Univesity",
   "education_second_box_descirption": "Technologies de l''information. Spécialisé dans le développement d'applications ou la programmation.",

   "academic":"Académique",
   "education_third_box_title":"Faculté des sciences mathématiques",
   "education_third_box_description": "L'analyse, l'algèbre, la géométrie, la théorie des probabilités et des statistiques, la logique, la démonstration, ainsi que le calcul vectoriel et matriciel.",
   ...
   "french": "Français (FR)",
   "french_desc": "/ 2ème native",
   "english": "Anglais (EN)",
   "english_desc": "Compétence professionnelle",
   "german": "Allemand (DE)",
   "german_desc": "Débutant",

   "my_works": "Mes travaux",
   "my_works_title": "Des solutions innovantes qui défient les attentes : Mes Projets",
   "my_works_introduction": "Conception de sites Web d'exception alliant fonctionnalité et esthétique, garantissant une utilité à long terme pour les utilisateurs. Élaboration d'une interface soigneusement conçue, claire et bien documentée, veillant à la fluidité et à l'intuitivité de chaque interaction. Objectif de création de solutions élégantes répondant aux besoins actuels des clients et les préparant pour l'avenir.",
   "load_more_work": "Charger plus de travail",
   "recommandation_title": "Curieux de savoir ce que mes collègues disent de moi ? Voici leurs avis !",
   "recommandation_introduction":"Dans le cadre de ma recherche de nouvelles opportunités professionnelles, je souhaite partager avec vous les recommandations de mes collaborateurs et mentors. Leurs commentaires témoignent de mes compétences, de mon éthique de travail et de ma capacité à collaborer efficacement en équipe. Chaque témoignage reflète une expérience unique, mettant en lumière les qualités qui font de moi un candidat idéal pour un poste en tant que développeur.",
   "recommandation_conclusion": "Vous pouvez ajouter des recommandations sur LinkedIn",
   "contact_title": "Avez-vous une idée ou un projet ?  N'hésitez pas à me laisser un message !",
   ...
   "send": "Envoyer",
    ...
    "recommandation_desc6": "Danih s'est rapidement intégré à l'équipe de notre projet chez eTech, adoptant avec aisance nos processus et outils. Toujours à l'écoute, il fait preuve d'une grande flexibilité pour s'adapter aux besoins de l'équipe. Sa persévérance face aux défis et son engagement constant sont impressionnants, ce qui en fait un collaborateur fiable et un atout précieux. \n Doté d'un excellent esprit d'équipe, Danih apporte une énergie positive qui renforce la dynamique du groupe.  \n L'une de ses récentes initiatives a été de s'intéresser à l'évolution de l'intelligence artificielle et de l'intégrer avec aisance dans les tâches quotidiennes du développeur, optimisant ainsi notre efficacité. \n Sa curiosité et sa volonté d'apprendre lui permettent de progresser rapidement et de contribuer de manière significative à chaque projet.  \n Je le recommande vivement.",
      ...
      "popup_image1title": "Technologie PHP 8",
      "popup_image1": "PHP 8 est utilisé pour orchestrer l'automatisation des processus ETL, notamment en facilitant l'extraction, la transformation et le chargement des données. Grâce à ses nouvelles fonctionnalités, telles que le compilateur JIT et les arguments nommés, PHP 8 optimise la manipulation des données complexes et assure un traitement efficace. Les propriétés typées et la gestion stricte des erreurs garantissent également la fiabilité et la robustesse des scripts ETL.",

      "popup_image2title": "Technologie Laravel 8",
      "popup_image2": "Laravel 8 est utilisé comme base pour structurer et orchestrer les processus ETL, offrant un environnement robuste et bien organisé pour l'extraction, la transformation et le chargement des données. Grâce à ses fonctionnalités avancées telles que les jobs planifiés (scheduling), les queues pour gérer les tâches en arrière-plan, et son puissant ORM Eloquent, Laravel facilite la gestion de gros volumes de données et assure un traitement efficace et sécurisé. Le framework permet également une intégration fluide avec divers systèmes de stockage et des bases de données relationnelles, tout en rendant le développement rapide et maintenable grâce à son architecture modulaire et évolutive.",

      "popup_image3title": "Technologie Docker",
      "popup_image3": "Docker est utilisé pour containeriser l'ensemble des processus ETL, assurant ainsi un environnement isolé et cohérent pour l'extraction, la transformation et le chargement des données. Chaque composant de la chaîne ETL (base de données, scripts de traitement, stockage) est encapsulé dans des conteneurs, garantissant une portabilité et une reproductibilité parfaites entre les environnements de développement, de test et de production. Docker permet également de simplifier le déploiement et la gestion des dépendances, tout en optimisant l'utilisation des ressources grâce à l'orchestration des conteneurs, assurant ainsi une exécution fluide et scalable du pipeline ETL.",

      "popup_image4title": "Jenkins",
      "popup_image4": "Jenkins est utilisé pour automatiser le déploiement et l'intégration continue (CI/CD) dans le cadre du projet ETL. Grâce à ses pipelines configurables, Jenkins permet de planifier et d'exécuter les tests, les builds et les déploiements, garantissant ainsi que les processus ETL soient systématiquement testés et déployés dans un environnement contrôlé. Cela assure une livraison continue et fiable des fonctionnalités, avec des retours rapides sur les éventuels problèmes.",

      "popup_image5title": "Bitbucket",
      "popup_image5": "Bitbucket sert de plateforme Git pour la gestion des versions et la collaboration sur le code source du projet ETL. Les fonctionnalités comme les pull requests et les pipelines Bitbucket CI permettent aux équipes de suivre les modifications du code et de garantir un développement sécurisé et transparent. Bitbucket s'intègre également avec d'autres outils de l'écosystème comme Jira et Confluence, facilitant ainsi une gestion efficace des projets.",

      "popup_image6title": "Linux Debian",
      "popup_image6": "Linux Debian est le système d'exploitation choisi pour héberger l'infrastructure du projet ETL. Connu pour sa stabilité, sa sécurité et sa grande compatibilité avec les technologies open-source, Debian assure un environnement fiable pour exécuter les conteneurs Docker, orchestrer les processus ETL, et gérer les différentes bases de données et services requis.",

      "popup_image7title": "PHPUnit avec Sail",
      "popup_image7": "PHPUnit est utilisé pour assurer la qualité du code dans le cadre du développement des processus ETL. Avec Laravel Sail, un environnement de développement local basé sur Docker, il est facile de configurer et d'exécuter des tests unitaires de manière cohérente et isolée. Cela garantit que chaque composant de l'ETL fonctionne comme prévu avant d'être intégré au pipeline principal.",

      "popup_image8title": "Atlassian (Gestion de Projet)",
      "popup_image8": "Atlassian est utilisé pour la gestion du projet ETL, permettant de suivre les tâches, les développements, les délais et les objectifs. Grâce à son intégration avec des outils tels que Jira et Confluence, Atlassian facilite une collaboration transparente entre les équipes, assurant que chaque étape du processus ETL soit bien documentée, suivie et réalisée dans les délais impartis.",

      "popup_image9title": "Jira",
      "popup_image9": "Jira est utilisé pour suivre les tâches et les incidents liés au développement du pipeline ETL. Chaque étape du processus, de l'extraction à la transformation et au chargement, est gérée et assignée dans Jira, permettant un suivi transparent et une gestion efficace des priorités. Les workflows personnalisés aident à optimiser les processus, avec des sprints pour gérer les cycles de développement.",

      "popup_image10title": "Confluence (Atlassian)",
      "popup_image10": "Confluence est utilisé pour la documentation et la collaboration autour du projet ETL. Chaque partie du processus, des détails techniques aux décisions de conception, est documentée dans Confluence, permettant à l'équipe de rester informée et à jour. Cette plateforme centralisée facilite également le partage des connaissances et la révision des informations critiques.",

      "popup_image11": "La méthodologie ETL repose sur Laravel pour orchestrer les étapes d'extraction, de transformation et de chargement. Laravel simplifie la création de pipelines ETL modulaires et extensibles, avec une gestion facile des tâches programmées et des files d'attente pour traiter les données en arrière-plan. Les fonctionnalités intégrées, telles que l'ORM Eloquent, facilitent la manipulation et la transformation des données avant de les charger dans un entrepôt central.",
      "popup_image11title": "Méthodologie ETL avec Laravel",

      "popup_image12": "Le projet ETL consiste à automatiser l'extraction des données de diverses sources (CSV, SQL), à les transformer par des processus complexes (nettoyage, enrichissement, génération de fonctionnalités), puis à les charger dans un entrepôt de données centralisé. Le processus ETL vise à rendre les données disponibles pour des analyses et visualisations en temps réel, garantissant ainsi une prise de décision basée sur des informations fiables et actualisées.",
      "popup_image12title": "Résumé général de l'ETL",

      "popup_image13": "Un tableau de bord graphique est intégré depuis un autre projet lié pour visualiser les mouvements et les statistiques, alimenté par l'ETL et les données disponibles. Grâce à cet outil, les utilisateurs peuvent surveiller chaque transaction, observer les mouvements des données (particulièrement les transformations), identifier les anomalies ou les goulets d'étranglement, et obtenir des insights immédiats sur les données transformées.",
      "popup_image13title": "Dashboard graphique de gestion",

      "popup_image14": "Tous les projets liés à l'ETL sont également conçus sous forme de microservices, chaque composant du pipeline étant découplé et communiquant via des API REST. Cela permet une flexibilité, modularité et évolutivité accrues du système. Chaque microservice gère une partie du processus (extraction, transformation ou chargement) et peut être déployé et mis à jour indépendamment, tout en interagissant de manière fluide avec les autres composants via des API standardisées.",
      "popup_image14title": "Microservice avec l'API",

      "popup_image15": "JavaScript ES6 permet d'améliorer la gestion de la logique côté client en introduisant des fonctionnalités modernes comme les classes, les modules, les promesses, et des raccourcis syntaxiques. Pour ce projet, l'ES6 facilite la manipulation du DOM, la gestion des événements utilisateur et l'envoi de requêtes asynchrones à l'API. Ces fonctionnalités permettent d'améliorer la fluidité et la réactivité de l'interface utilisateur.",
      "popup_image15title": "JavaScript ES6 (ECMAScript 6)",

      "popup_image16": "jQuery simplifie les interactions avec le DOM, la gestion des animations, les requêtes AJAX et la manipulation d'événements. Bien qu'ES6 offre des alternatives natives, jQuery est toujours utile pour assurer la compatibilité avec les anciens navigateurs et simplifier certaines tâches complexes. Dans ce projet, jQuery peut être utilisé pour gérer des composants interactifs rapidement et efficacement.",
      "popup_image16title": "jQuery",

      "popup_image17": "Webpack est un module bundler qui facilite la gestion des dépendances et la compilation des fichiers JavaScript, CSS, images, et autres ressources dans le projet. Pour une application SaaS, Webpack peut être utilisé pour optimiser les performances en créant des bundles de fichiers compressés et en chargeant dynamiquement les composants nécessaires, ce qui améliore le temps de chargement de l'application.",
      "popup_image17title": "Webpack",

      "popup_image18": "Metronic 8 est un tableau de bord d'administration basé sur Bootstrap, conçu pour être facilement intégré dans des applications web. Dans ce projet, Metronic 8 permet de créer une interface utilisateur soignée et moderne pour les utilisateurs de l'application SaaS, avec des composants prêts à l'emploi pour les graphiques, les formulaires et les tableaux de bord statistiques.",
      "popup_image18title": "Metronic 8 Dashboard",

      "popup_image19": "PHP 8 offre des améliorations significatives en termes de performances grâce à son compilateur JIT (Just-In-Time). Dans le cadre du projet, PHP 8 permet d'optimiser les opérations backend pour la gestion et le traitement des données, en particulier pour les tâches de collecte et d'analyse statistique. De plus, les nouvelles fonctionnalités comme les Union Types, Named Arguments et les Attributes permettent une écriture de code plus flexible et lisible.",
      "popup_image19title": "PHP version 8",

      "popup_image20": "SSH (Secure Shell) est un protocole qui permet d’administrer les serveurs à distance de manière sécurisée. Dans ce projet, SSH est utilisé pour le déploiement, la gestion et la maintenance de l'application sur le serveur, garantissant la sécurité des connexions et des transferts de données lors des mises à jour ou des configurations.",
      "popup_image20title": "Serveur SSH",

      "popup_image21": "SCRUM est une méthodologie Agile utilisée pour la gestion de projets complexes, notamment en développement logiciel. Dans le contexte de l'optimisation d'une application SaaS, SCRUM permet de structurer et d'organiser le travail en petites itérations appelées sprints, ce qui permet de livrer rapidement des fonctionnalités utilisables et d'obtenir des retours réguliers des utilisateurs ou parties prenantes. SCRUM favorise la collaboration entre les équipes, assure une adaptation continue aux changements et améliore la qualité du produit final.",
      "popup_image21title": "SCRUM",

      "popup_image22": "Laravel est un framework PHP utilisé pour le traitement backend du projet. Il offre une architecture MVC qui facilite le développement rapide d’applications web robustes. Pour ce projet, Laravel permet de structurer les requêtes API, de gérer les bases de données et de mettre en place des systèmes de validation, tout en intégrant des fonctionnalités comme les notifications, les files d'attente (queues), et la gestion des utilisateurs.",
      "popup_image22title": "Traitement Backend avec Laravel",

      "popup_image23": "Jetstream et Breeze sont des options d'authentification, accompagnées de rôles et permissions configurés via des politiques. La protection CSRF est activée, les données sont validées avec rigueur, et les mots de passe sont chiffrés avec bcrypt. Les fichiers sont stockés en toute sécurité, les données sensibles sont cryptées, et une protection contre les attaques XSS est assurée en échappant les données dans les vues. Un audit des actions utilisateurs est implémenté, avec une limitation des tentatives de connexion pour prévenir les attaques par force brute.",
      "popup_image23title": "Sécurité Laravel",

      "popup_image24": "Le code est structuré de façon modulaire pour une architecture claire. Les migrations sont utilisées pour la base de données, et le scheduler pour automatiser les tâches. Les configurations sont gérées avec des fichiers .env, tandis que les déploiements sont automatisés via des pipelines CI/CD. PHPUnit est utilisé pour les tests automatisés, et des caches comme Redis ou Memcached optimisent les performances.",
      "popup_image24title": "Gestion Laravel",

      "popup_image25": "XML est utilisé pour créer l'interface utilisateur avec des layouts comme ConstraintLayout. L'application assure une accessibilité optimale avec des descriptions de contenu, en suivant les bonnes pratiques d'accessibilité. La cohérence visuelle est maintenue grâce aux styles et thèmes XML, et des animations sont ajoutées pour dynamiser l'interface.",
      "popup_image25title": "Affichage Android avec XML",

      "popup_image26": "Orchid est un ERP bancaire, permettant de gérer les comptes clients, transactions, prêts et crédits. Il intègre des fonctions de gestion des risques et de conformité. Utilisé comme backend pour une application bancaire, il expose des API pour synchroniser les données en temps réel et est déployé sur des serveurs robustes avec des bases de données comme Oracle ou MySQL.",
      "popup_image26title": "Système Orchid (ERP bancaire)",

      "popup_image27": "Java est un langage clé pour le développement Android, favorisant la programmation orientée objet et l'intégration avec l'Android SDK. Les threads sont utilisés pour les tâches lourdes, et des services d'arrière-plan assurent la réactivité de l'application même en inactivité. La gestion des événements système via BroadcastReceiver optimise l'expérience utilisateur.",
      "popup_image27title": "Langage JAVA pour Android",
  ...
  "en": {
    ...
    "education_first_box_title": "University of Côte d'Azur",
    ...
    "recommandation_desc6": "Danih quickly integrated into our project team at eTech, adopting our processes and tools with ease. Always attentive, he demonstrates great flexibility in adapting to the team's needs. His perseverance in the face of challenges and constant commitment are impressive, making him a reliable collaborator and a valuable asset. \n With an excellent team spirit, Danih brings positive energy that strengthens the group's dynamic. \n One of his recent initiatives was showing interest in the evolution of artificial intelligence and integrating it seamlessly into a developer's daily tasks, thus optimizing our efficiency. \n His curiosity and desire to learn allow him to progress quickly and contribute significantly to each project. \n I highly recommend him.",
      ...
      "popup_image1": "PHP 8 is used to orchestrate the automation of ETL processes, particularly by facilitating the extraction, transformation, and loading of data. With its new features, such as the JIT compiler and named arguments, PHP 8 optimizes the manipulation of complex data and ensures efficient processing. Typed properties and strict error handling also guarantee the reliability and robustness of ETL scripts.",
      "popup_image1title": "PHP 8 Technology",

      "popup_image2": "Laravel 8 is used as a foundation to structure and orchestrate ETL processes, providing a robust and well-organized environment for data extraction, transformation, and loading. With advanced features such as scheduled jobs, queues for managing background tasks, and its powerful Eloquent ORM, Laravel facilitates the handling of large data volumes and ensures effective and secure processing. The framework also allows seamless integration with various storage systems and relational databases while making development fast and maintainable due to its modular and scalable architecture.",
      "popup_image2title": "Laravel 8 Technology",

      "popup_image3": "Docker is used to containerize all ETL processes, ensuring an isolated and consistent environment for data extraction, transformation, and loading. Each component of the ETL chain (database, processing scripts, storage) is encapsulated in containers, guaranteeing perfect portability and reproducibility between development, testing, and production environments. Docker also simplifies deployment and dependency management while optimizing resource use through container orchestration, ensuring smooth and scalable execution of the ETL pipeline.",
      "popup_image3title": "Docker Technology",

      "popup_image4": "Jenkins is used to automate deployment and continuous integration (CI/CD) within the ETL project. With its configurable pipelines, Jenkins allows scheduling and executing tests, builds, and deployments, ensuring that ETL processes are systematically tested and deployed in a controlled environment. This guarantees continuous and reliable delivery of features, with quick feedback on any issues.",
      "popup_image4title": "Jenkins",

      "popup_image5": "Bitbucket serves as a Git platform for version control and collaboration on the ETL project’s source code. Features like pull requests and Bitbucket CI pipelines enable teams to track code changes and ensure secure and transparent development. Bitbucket also integrates with other tools in the ecosystem like Jira and Confluence, facilitating effective project management.",
      "popup_image5title": "Bitbucket",

      "popup_image6": "Linux Debian is the chosen operating system to host the ETL project infrastructure. Known for its stability, security, and broad compatibility with open-source technologies, Debian ensures a reliable environment for running Docker containers, orchestrating ETL processes, and managing the various databases and services required.",
      "popup_image6title": "Linux Debian",

      "popup_image7": "PHPUnit is used to ensure code quality in the development of ETL processes. With Laravel Sail, a Docker-based local development environment, it is easy to set up and execute unit tests consistently and in isolation. This ensures that each component of the ETL functions as expected before being integrated into the main pipeline.",
      "popup_image7title": "PHPUnit with Sail",

      "popup_image8": "Atlassian is used for managing the ETL project, allowing tracking of tasks, developments, deadlines, and goals. Through its integration with tools like Jira and Confluence, Atlassian facilitates seamless collaboration among teams, ensuring that each step of the ETL process is well documented, tracked, and completed on time.",
      "popup_image8title": "Atlassian (Project Management)",

      "popup_image9": "Jira is used to track tasks and incidents related to the development of the ETL pipeline. Each step of the process, from extraction to transformation and loading, is managed and assigned in Jira, allowing for transparent tracking and effective priority management. Custom workflows help optimize processes, with sprints to manage development cycles.",
      "popup_image9title": "Jira",

      "popup_image10": "Confluence is used for documentation and collaboration around the ETL project. Every part of the process, from technical details to design decisions, is documented in Confluence, allowing the team to stay informed and up-to-date. This centralized platform also facilitates knowledge sharing and revision of critical information.",
      "popup_image10title": "Confluence (Atlassian)",

      "popup_image11": "The ETL methodology relies on Laravel to orchestrate the stages of extraction, transformation, and loading. Laravel simplifies the creation of modular and extensible ETL pipelines, with easy management of scheduled tasks and queues to process data in the background. Built-in features, like the Eloquent ORM, streamline the manipulation and transformation of data before loading it into a central warehouse.",
      "popup_image11title": "ETL Methodology with Laravel",

      "popup_image12": "The ETL project involves automating the extraction of data from various sources (CSV, SQL), transforming it through complex processes (cleaning, enrichment, feature generation), and then loading it into a centralized data warehouse. The ETL process aims to make data available for real-time analysis and visualization, ensuring data-driven decision-making based on reliable and up-to-date information.",
      "popup_image12title": "General Summary of ETL",

      "popup_image13": "A graphical dashboard from a related project is integrated to visualize movements and statistics, powered by the ETL and available data. With this tool, users can monitor each transaction, observe data flows (particularly transformations), identify anomalies or bottlenecks, and gain immediate insights into the transformed data.",
      "popup_image13title": "Graphical Management Dashboard",

      "popup_image14": "All projects related to the ETL are also designed as microservices, with each component of the pipeline decoupled and communicating via REST APIs. This ensures greater system flexibility, modularity, and scalability. Each microservice handles a part of the process (extraction, transformation, or loading) and can be deployed and updated independently while interacting smoothly with other components through standardized APIs.",
      "popup_image14title": "Microservice with API",

      "popup_image15": "JavaScript ES6 enhances client-side logic management by introducing modern features like classes, modules, promises, and shorthand syntax. For this project, ES6 facilitates DOM manipulation, user event handling, and asynchronous requests to the API. These features improve the fluidity and responsiveness of the user interface.",
      "popup_image15title": "JavaScript ES6 (ECMAScript 6)",

      "popup_image16": "jQuery simplifies interactions with the DOM, animation management, AJAX requests, and event manipulation. Although ES6 offers native alternatives, jQuery is still useful for ensuring compatibility with older browsers and simplifying some complex tasks. In this project, jQuery can be used to manage interactive components quickly and efficiently.",
      "popup_image16title": "jQuery",

      "popup_image17": "Webpack is a module bundler that simplifies dependency management and compiles JavaScript, CSS, images, and other resources in the project. For a SaaS application, Webpack can be used to optimize performance by creating compressed file bundles and dynamically loading the necessary components, improving application load time.",
      "popup_image17title": "Webpack",

      "popup_image18": "Metronic 8 is an administration dashboard based on Bootstrap, designed to be easily integrated into web applications. In this project, Metronic 8 allows for the creation of a clean and modern user interface for users of the SaaS application, with ready-to-use components for graphs, forms, and statistical dashboards.",
      "popup_image18title": "Metronic 8 Dashboard",

      "popup_image19": "PHP 8 provides significant performance improvements through its JIT (Just-In-Time) compiler. Within the project, PHP 8 optimizes backend operations for data management and processing, particularly for data collection and statistical analysis tasks. Additionally, new features like Union Types, Named Arguments, and Attributes allow for more flexible and readable code writing.",
      "popup_image19title": "PHP Version 8",

      "popup_image20": "SSH (Secure Shell) is a protocol that allows secure remote management of servers. In this project, SSH is used for deployment, management, and maintenance of the application on the server, ensuring the security of connections and data transfers during updates or configurations.",
      "popup_image20title": "SSH Server",

      "popup_image21": "SCRUM is an Agile methodology used for managing complex projects, particularly in software development. In the context of optimizing a SaaS application, SCRUM helps structure and organize work in small iterations called sprints, allowing for the rapid delivery of usable features and regular feedback from users or stakeholders. SCRUM promotes collaboration among teams, ensures continuous adaptation to changes, and improves the quality of the final product.",
      "popup_image21title": "SCRUM",

      "popup_image22": "Laravel is a PHP framework used for backend processing of the project. It offers an MVC architecture that facilitates the rapid development of robust web applications. For this project, Laravel allows for structuring API requests, managing databases, and implementing validation systems, while integrating features like notifications, queues, and user management.",
      "popup_image22title": "Backend Processing with Laravel",

      "popup_image23": "Jetstream and Breeze provide authentication options, with roles and permissions managed through policies. CSRF protection is enabled, data is strictly validated, and passwords are encrypted with bcrypt. Files are stored securely, sensitive data is encrypted, and XSS attacks are prevented by escaping data in views. User actions are audited, with login attempt limits to prevent brute-force attacks.",
      "popup_image23title": "Laravel Security",

      "popup_image24": "The code is modularly structured for a clear architecture. Migrations are used for the database, and the scheduler automates tasks. Configurations are managed with .env files, while deployments are automated via CI/CD pipelines. PHPUnit is used for automated testing, and caches like Redis or Memcached optimize performance.",
      "popup_image24title": "Laravel Management",

      "popup_image25": "XML is used to create the user interface with layouts like ConstraintLayout. The application ensures optimal accessibility with content descriptions, following best accessibility practices. Visual consistency is maintained with XML styles and themes, and animations are added to enhance the interface.",
      "popup_image25title": "Android Display with XML",

      "popup_image26": "Orchid is a banking ERP used to manage customer accounts, transactions, loans, and credits. It includes risk management and compliance features. Used as a backend for a banking application, it exposes APIs for real-time data synchronization and is deployed on robust servers with databases like Oracle or MySQL.",
      "popup_image26title": "Orchid System (Banking ERP)",

      "popup_image27": "Java is a key language for Android development, supporting object-oriented programming and integration with the Android SDK. Threads are used for heavy tasks, and background services ensure app responsiveness even when inactive. System event management through BroadcastReceiver optimizes the user experience.",
      "popup_image27title": "Java Language for Android",
  ...
  "de": {
   ...
   "recommandation_name1": "Diary Razafinjatovo · 1.",
    ...
    "recommandation_desc6": "Danih hat sich schnell in unser Projektteam bei eTech integriert und unsere Prozesse und Tools mit Leichtigkeit übernommen. Er ist immer aufmerksam und zeigt eine große Flexibilität, um sich an die Bedürfnisse des Teams anzupassen. Sein Durchhaltevermögen angesichts von Herausforderungen und sein ständiges Engagement sind beeindruckend, was ihn zu einem zuverlässigen Mitarbeiter und einem wertvollen Mitglied macht. \n Mit einem ausgezeichneten Teamgeist bringt Danih eine positive Energie ein, die die Dynamik der Gruppe stärkt. \n Eine seiner jüngsten Initiativen war es, sich für die Entwicklung der künstlichen Intelligenz zu interessieren und sie mühelos in die täglichen Aufgaben eines Entwicklers zu integrieren, wodurch unsere Effizienz optimiert wurde. \n Seine Neugier und sein Lernwille ermöglichen es ihm, schnell voranzukommen und bedeutende Beiträge zu jedem Projekt zu leisten. \n Ich empfehle ihn wärmstens.",
      ...
      "popup_image1": "PHP 8 wird verwendet, um die Automatisierung von ETL-Prozessen zu orchestrieren, insbesondere zur Erleichterung der Extraktion, Transformation und des Ladens von Daten. Dank seiner neuen Funktionen wie dem JIT-Compiler und benannten Argumenten optimiert PHP 8 die Verarbeitung komplexer Daten und gewährleistet eine effiziente Verarbeitung. Typisierte Eigenschaften und strenge Fehlerbehandlung gewährleisten auch die Zuverlässigkeit und Robustheit von ETL-Skripten.",
      "popup_image1title": "PHP 8 Technologie",

      "popup_image2": "Laravel 8 wird als Grundlage verwendet, um ETL-Prozesse zu strukturieren und zu orchestrieren, und bietet eine robuste und gut organisierte Umgebung für die Extraktion, Transformation und das Laden von Daten. Mit seinen erweiterten Funktionen wie zeitgesteuerten Jobs (Scheduling), Warteschlangen zur Verwaltung von Hintergrundaufgaben und seinem leistungsstarken ORM Eloquent erleichtert Laravel die Verwaltung großer Datenmengen und gewährleistet eine effiziente und sichere Verarbeitung. Das Framework ermöglicht auch eine nahtlose Integration mit verschiedenen Speichersystemen und relationalen Datenbanken, während es dank seiner modularen und skalierbaren Architektur eine schnelle und wartbare Entwicklung ermöglicht.",
      "popup_image2title": "Laravel 8 Technologie",

      "popup_image3": "Docker wird verwendet, um alle ETL-Prozesse zu containerisieren, und bietet so eine isolierte und konsistente Umgebung für die Extraktion, Transformation und das Laden von Daten. Jede Komponente der ETL-Kette (Datenbank, Verarbeitungsskripte, Speicherung) ist in Containern gekapselt, was eine perfekte Portabilität und Reproduzierbarkeit zwischen Entwicklungs-, Test- und Produktionsumgebungen gewährleistet. Docker vereinfacht auch das Deployment und das Management von Abhängigkeiten, während es die Ressourcennutzung durch die Orchestrierung von Containern optimiert und somit eine reibungslose und skalierbare Ausführung des ETL-Pipelines gewährleistet.",
      "popup_image3title": "Docker Technologie",

      "popup_image4": "Jenkins wird verwendet, um das Deployment und die kontinuierliche Integration (CI/CD) im Rahmen des ETL-Projekts zu automatisieren. Mit seinen konfigurierbaren Pipelines ermöglicht Jenkins die Planung und Ausführung von Tests, Builds und Deployments, wodurch sichergestellt wird, dass die ETL-Prozesse systematisch getestet und in einer kontrollierten Umgebung bereitgestellt werden. Dies gewährleistet eine kontinuierliche und zuverlässige Bereitstellung von Funktionen mit schnellen Rückmeldungen zu möglichen Problemen.",
      "popup_image4title": "Jenkins",

      "popup_image5": "Bitbucket dient als Git-Plattform für die Versionsverwaltung und die Zusammenarbeit am Quellcode des ETL-Projekts. Funktionen wie Pull-Requests und Bitbucket CI-Pipelines ermöglichen es den Teams, Codeänderungen zu verfolgen und eine sichere und transparente Entwicklung zu gewährleisten. Bitbucket integriert sich auch mit anderen Tools im Ökosystem wie Jira und Confluence und erleichtert so ein effektives Projektmanagement.",
      "popup_image5title": "Bitbucket",

      "popup_image6": "Linux Debian ist das Betriebssystem, das für das Hosting der Infrastruktur des ETL-Projekts ausgewählt wurde. Bekannt für seine Stabilität, Sicherheit und große Kompatibilität mit Open-Source-Technologien bietet Debian eine zuverlässige Umgebung zum Ausführen von Docker-Containern, zur Orchestrierung von ETL-Prozessen und zur Verwaltung der erforderlichen Datenbanken und Dienste.",
      "popup_image6title": "Linux Debian",

      "popup_image7": "PHPUnit wird verwendet, um die Codequalität im Rahmen der Entwicklung von ETL-Prozessen sicherzustellen. Mit Laravel Sail, einer auf Docker basierenden lokalen Entwicklungsumgebung, ist es einfach, Unit-Tests konsistent und isoliert zu konfigurieren und auszuführen. Dies gewährleistet, dass jede Komponente des ETL wie vorgesehen funktioniert, bevor sie in die Hauptpipeline integriert wird.",
      "popup_image7title": "PHPUnit mit Sail",

      "popup_image8": "Atlassian wird für das Management des ETL-Projekts verwendet und ermöglicht das Verfolgen von Aufgaben, Entwicklungen, Fristen und Zielen. Dank der Integration mit Tools wie Jira und Confluence erleichtert Atlassian eine transparente Zusammenarbeit zwischen den Teams und stellt sicher, dass jeder Schritt des ETL-Prozesses gut dokumentiert, verfolgt und fristgerecht abgeschlossen wird.",
      "popup_image8title": "Atlassian (Projektmanagement)",

      "popup_image9": "Jira wird verwendet, um die Aufgaben und Vorfälle im Zusammenhang mit der Entwicklung der ETL-Pipeline zu verfolgen. Jeder Schritt des Prozesses, von der Extraktion über die Transformation bis hin zum Laden, wird in Jira verwaltet und zugewiesen, was eine transparente Nachverfolgung und ein effektives Prioritätenmanagement ermöglicht. Die benutzerdefinierten Workflows helfen dabei, die Prozesse zu optimieren, mit Sprints zur Verwaltung der Entwicklungszyklen.",
      "popup_image9title": "Jira",

      "popup_image10": "Confluence wird für die Dokumentation und die Zusammenarbeit rund um das ETL-Projekt verwendet. Jeder Teil des Prozesses, von technischen Details bis zu Entwurfsentscheidungen, wird in Confluence dokumentiert, sodass das Team informiert und auf dem neuesten Stand bleibt. Diese zentrale Plattform erleichtert auch den Wissensaustausch und die Überprüfung kritischer Informationen.",
      "popup_image10title": "Confluence (Atlassian)",

      "popup_image11title": "ETL-Methodologie mit Laravel",
      "popup_image11": "Die ETL-Methodologie basiert auf Laravel, um die Schritte der Extraktion, Transformation und des Ladens zu orchestrieren. Laravel erleichtert die Erstellung modularer und erweiterbarer ETL-Pipelines, mit einer einfachen Verwaltung geplanter Aufgaben und Warteschlangen zur Verarbeitung von Daten im Hintergrund. Die integrierten Funktionen, wie das ORM Eloquent, vereinfachen die Manipulation und Transformation von Daten, bevor sie in ein zentrales Lager geladen werden.",

      "popup_image12title": "Allgemeine Zusammenfassung des ETL",
      "popup_image12": "Das ETL-Projekt besteht darin, die Extraktion von Daten aus verschiedenen Quellen (CSV, SQL) zu automatisieren, sie durch komplexe Prozesse (Bereinigung, Anreicherung, Generierung von Merkmalen) zu transformieren und sie dann in ein zentrales Data Warehouse zu laden. Der ETL-Prozess zielt darauf ab, Daten für Analysen und Echtzeitvisualisierungen verfügbar zu machen, um sicherzustellen, dass Entscheidungen auf zuverlässigen und aktuellen Daten basieren.",

      "popup_image13title": "Grafisches Management-Dashboard",
      "popup_image13": "Ein grafisches Dashboard aus einem verwandten Projekt ist integriert, um Bewegungen und Statistiken anzuzeigen, die vom ETL und den verfügbaren Daten gespeist werden. Mit diesem Tool können Benutzer jede Transaktion überwachen, Datenbewegungen (insbesondere Transformationen) beobachten, Anomalien oder Engpässe erkennen und sofortige Einblicke in die transformierten Daten erhalten.",

      "popup_image14title": "Mikroservice mit API",
      "popup_image14": "Alle ETL-bezogenen Projekte sind ebenfalls als Microservices konzipiert, wobei jede Komponente der Pipeline entkoppelt und über REST-APIs kommuniziert. Dies gewährleistet eine größere Flexibilität, Modularität und Skalierbarkeit des Systems. Jeder Microservice übernimmt einen Teil des Prozesses (Extraktion, Transformation oder Laden) und kann unabhängig bereitgestellt und aktualisiert werden, während er nahtlos mit den anderen Komponenten über standardisierte APIs interagiert.",

      "popup_image15title": "JavaScript ES6 (ECMAScript 6)",
      "popup_image15": "JavaScript ES6 verbessert die Verwaltung der Logik auf der Client-Seite, indem es moderne Funktionen wie Klassen, Module, Promises und Syntaxkürzungen einführt. Für dieses Projekt erleichtert ES6 die Manipulation des DOM, die Verwaltung von Benutzerevents und das Senden von asynchronen Anfragen an die API. Diese Funktionen verbessern die Fluidität und Reaktivität der Benutzeroberfläche.",

      "popup_image16title": "jQuery",
      "popup_image16": "jQuery vereinfacht die Interaktionen mit dem DOM, die Verwaltung von Animationen, AJAX-Anfragen und die Ereignisbehandlung. Obwohl ES6 native Alternativen bietet, ist jQuery nach wie vor nützlich, um die Kompatibilität mit älteren Browsern sicherzustellen und einige komplexe Aufgaben zu vereinfachen. In diesem Projekt kann jQuery verwendet werden, um interaktive Komponenten schnell und effizient zu verwalten.",

      "popup_image17title": "Webpack",
      "popup_image17": "Webpack ist ein Modul-Bundler, der die Verwaltung von Abhängigkeiten und die Kompilierung von JavaScript-, CSS-, Bild- und anderen Ressourcen im Projekt erleichtert. Für eine SaaS-Anwendung kann Webpack verwendet werden, um die Leistung zu optimieren, indem komprimierte Datei-Bundles erstellt und die erforderlichen Komponenten dynamisch geladen werden, was die Ladezeiten der Anwendung verbessert.",

      "popup_image18title": "Metronic 8 Dashboard",
      "popup_image18": "Metronic 8 ist ein auf Bootstrap basierendes Administrations-Dashboard, das für die einfache Integration in Webanwendungen konzipiert ist. In diesem Projekt ermöglicht Metronic 8 die Erstellung einer sauberen und modernen Benutzeroberfläche für die Benutzer der SaaS-Anwendung, mit sofort einsatzbereiten Komponenten für Grafiken, Formulare und statistische Dashboards.",

      "popup_image19title": "PHP Version 8",
      "popup_image19": "PHP 8 bietet signifikante Leistungsverbesserungen durch seinen JIT-Compiler (Just-In-Time). Im Rahmen des Projekts ermöglicht PHP 8 die Optimierung der Backend-Operationen zur Verwaltung und Verarbeitung von Daten, insbesondere für Aufgaben der Datensammlung und statistischen Analyse. Darüber hinaus ermöglichen neue Funktionen wie Union Types, Named Arguments und Attributes eine flexiblere und lesbarere Code-Schreibung.",

      "popup_image20title": "SSH-Server",
      "popup_image20": "SSH (Secure Shell) ist ein Protokoll, das die sichere Verwaltung von Servern aus der Ferne ermöglicht. In diesem Projekt wird SSH für das Deployment, die Verwaltung und die Wartung der Anwendung auf dem Server verwendet, um die Sicherheit der Verbindungen und Datenübertragungen während Updates oder Konfigurationen zu gewährleisten.",

      "popup_image21title": "SCRUM",
      "popup_image21": "SCRUM ist eine Agile-Methodik, die für die Verwaltung komplexer Projekte, insbesondere in der Softwareentwicklung, verwendet wird. Im Kontext der Optimierung einer SaaS-Anwendung ermöglicht SCRUM die Strukturierung und Organisation der Arbeit in kleinen Iterationen, sogenannten Sprints, was eine schnelle Bereitstellung von nutzbaren Funktionen und regelmäßiges Feedback von Benutzern oder Interessengruppen ermöglicht. SCRUM fördert die Zusammenarbeit zwischen den Teams, sorgt für eine kontinuierliche Anpassung an Veränderungen und verbessert die Qualität des Endprodukts.",

      "popup_image22title": "Backend-Verarbeitung mit Laravel",
      "popup_image22": "Laravel ist ein PHP-Framework, das für die Backend-Verarbeitung des Projekts verwendet wird. Es bietet eine MVC-Architektur, die die schnelle Entwicklung robuster Webanwendungen erleichtert. Für dieses Projekt ermöglicht Laravel die Strukturierung von API-Anfragen, die Verwaltung von Datenbanken und die Implementierung von Validierungssystemen, während Funktionen wie Benachrichtigungen, Warteschlangen und Benutzerverwaltung integriert werden.",

      "popup_image23title": "Laravel-Sicherheit",
      "popup_image23": "Jetstream und Breeze sind Authentifizierungsoptionen, die zusammen mit Rollen und Berechtigungen über Richtlinien konfiguriert sind. Der CSRF-Schutz ist aktiviert, Daten werden rigoros validiert, und Passwörter werden mit bcrypt verschlüsselt. Dateien werden sicher gespeichert, sensible Daten werden verschlüsselt, und ein Schutz vor XSS-Angriffen wird durch Escape-Sequenzen in den Ansichten gewährleistet. Ein Benutzeraktionsaudit ist implementiert, und eine Begrenzung der Anmeldeversuche verhindert Brute-Force-Angriffe.",

      "popup_image24title": "Laravel-Verwaltung",
      "popup_image24": "Der Code ist modular strukturiert für eine klare Architektur. Migrationen werden für die Datenbank verwendet und der Scheduler automatisiert Aufgaben. Konfigurationen werden über .env-Dateien verwaltet, während Deployments über CI/CD-Pipelines automatisiert werden. PHPUnit wird für automatisierte Tests verwendet, und Caches wie Redis oder Memcached optimieren die Leistung.",

      "popup_image25title": "Android-Anzeige mit XML",
      "popup_image25": "XML wird verwendet, um die Benutzeroberfläche mit Layouts wie ConstraintLayout zu erstellen. Die App gewährleistet optimale Barrierefreiheit durch Inhaltsbeschreibungen, die den besten Barrierefreiheitspraktiken folgen. Die visuelle Konsistenz wird durch XML-Stile und -Themen aufrechterhalten, und Animationen fügen der Benutzeroberfläche Dynamik hinzu.",

      "popup_image26title": "Orchid-System (Bank-ERP)",
      "popup_image26": "Orchid ist ein Bank-ERP zur Verwaltung von Kundenkonten, Transaktionen, Darlehen und Krediten. Es integriert Risikomanagement- und Compliance-Funktionen. Es wird als Backend für eine Banking-Anwendung verwendet, stellt APIs für die Echtzeit-Datensynchronisation bereit und wird auf robusten Servern mit Datenbanken wie Oracle oder MySQL eingesetzt.",

      "popup_image27title": "JAVA-Sprache für Android",
      "popup_image27": "Java ist eine Schlüsseltechnologie für die Android-Entwicklung, die objektorientierte Programmierung und die Integration mit dem Android-SDK unterstützt. Threads werden für schwere Aufgaben verwendet, und Hintergrunddienste gewährleisten die Reaktionsfähigkeit der App auch im Leerlauf. Das Ereignismanagement des Systems über BroadcastReceiver optimiert die Benutzererfahrung.",
...
//service
  ...
  "mg": {
    ...
    "skills_desc": "Ireto ary ny fahaiza-manao teknika sy fitaovana fampivoarana ahafahako manova hevitra ho lasa fampiharana tranonkala miasa tsara sy mora azo avy hatrany, miaraka amin'ny fahaiza-manaona programa, framework ankehitriny, ary tontolo teknolojia voaomana tsara.",
    "skills_button": "Fahaiza-manao",
    "tools_button": "Fitaovana",

    "my_experiences": "Asa matihanina",
    "experience_title": "Mihoatra ny 3 taona niainana teo amin'ny indostria miaraka amin'ny tetikasa manokana betsaka",
    "experience_introduction": "Nahazo fahafahana niasa tamin'ny tetikasa maro aho, indrindra amin'ny sehatry ny vahaolana SaaS sy ny serivisy rahona (Cloud). Nandritra ireo traikefa ireo, nandray anjara tamin'ny asa sy andraikitra maro aho, manomboka amin'ny fampandrosoana endri-javatra manokana ka hatramin'ny fanatsarana ny rafitra. Izany traikefa izany dia nanome ahy fahatakarana matotra ny fanamby ara-teknika sy ny fomba fanao tsara indrindra mifandraika amin'ireo tontolo iainana mavitrika ireo.",

    "june_2023_present": "Jona 2023 - Ankehitriny 2024",
    "first_box_title": "Fitantanana Angona amin'ny ETL",
    "first_box_description": "Fanangonana: \n Fampidirana angon-drakitra maro (CSV, SQL). \n Fanangonana angon-drakitra voalahatra sy matetika. \n Fanodinana mialoha, fanitsiana sy fanatsarana ny endrikin'ny angon-drakitra. \n \n Fanovana: \n Fampiharana fanovana sarotra amin'ny alalan'ny pipelines. \n Fanadiovana sy fampivoarana ny angona. \n Famoronana endri-javatra vaovao avy amin'ny angon-drakitra voalohany. \n \n Fanangonana: \n Fitahirizana ny angona ao amin'ny toerana voatokana sy vokarakara. \n Fisian'ny angon-drakitra ho an'ny famakafakana sy ny fijerena sary.",
    "techno": "Tontolo teknolojia amin'ny fampandrosoana",

    "june_2022_june_2023": "Jona 2022 - Jona 2023",
    "second_box_title": "Fanatsarana SaaS",
    "second_box_description": "Fanatsarana ny fampiharana tranonkala amin'ny fitantanana angona mba hampitomboana ny fahombiazan'ny fanangonana statistika sy ny fahamarinan'ny angona. Ity tetikasa ity dia mikendry ny hampiditra endri-javatra mandroso hanamora ny fidirana angona, ny fanodinana ary ny famakafakana raha miantoka ny fisian'ny endrika mora azo sy mora ampiasaina.",
    "specifications": "Fepetra",
    "specifications_descriptions": "Fitantanana tetikasa ho an'ny fanangonana: banky angon-drakitra, fifandraisana amin'ny ekosistemam-panjifa, fanodinana sheky, fitadiavana mpanjifa amin'ny varotra ary fijerena angon-drakitra amin'ny sary.",

    "feb_2022_mai_2022": "Febroary 2022 - Mey 2022",
    "third_box_title": "Fanamboarana ny Rafitra Fidirana Angona",
    "third_box_description": "Fanamboarana sy fanatsarana ny fitaovana fidirana angon-drakitra, manampy fanamarinana mandroso, fahafahana mampiditra rakitra, fanondranana ny angona voahodina, ary fitantanana mpampiasa miaraka amin'ny zo fidirana.",
    ...
    "education_description": "Nandritra ny lalamianarako amin'ny fampandrosoana informatika, nahazo fahafahana nahazona mari-pahaizana master tao amin'ny iray amin'ireo oniversite tsara indrindra tao Eoropa aho, izay nianarako lalina ny fahaiza-manao ara-teorika sy ara-pratika. Ity traikefa ity dia nanampy ahy hanatsara ny fahaiza-manao rindrambaiko, nampihatra sy nankafy ny fanabeazana informatika matanjaka nentin'ny oniversite teo an-toerana. Mandritra izany fotoana izany, nahazo fototra mafy amin'ny matematika aho, izay ilaina amin'ny famahana olana sarotra sy ny fanatsarana ny algoritma, ka nanomana ahy hiatrika ny fanamby ara-teknika ao amin'ny indostria.",
    ...
    "license": "Diploma licence",
    "education_second_box_title": "Oniversite Informatika",
    "education_second_box_descirption": "Mari-pahaizana licence amin'ny Teknolojia Fampahalalam-baovao. Mifantoka tamin'ny fampandrosoana fampiharana na fandaharana rindrambaiko.",
    ...
    "contact_desc": "Raha mila fanampiana ianao, aza misalasala mifandray amiko ary ampahafantaro ahy ny fomba hanampiana anao. Fenoy ny taratasy (formulaire)  ary hamerina valiny aminao faran'izay haingana aho.",
    "address": "Adiresy:",
    "phone": "Telefaonina:",
    ...
    "recommandation_desc6": "Niditra haingana tao anatin'ny ekipanay tao amin'ny tetikasa tao eTech i Danih, nanaraka mora ny fizotrany sy ny fitaovana nampiasaina. Mpitily hatrany izy, mampiseho fahaizana mifanampy lehibe mba hanaraka ny filan'ny ekipa. Tena mahatalanjona ny faharetany sy ny fahavononany, izay mahatonga azy ho mpiara-miasa azo itokisana sy tena sarobidy. \n Manana fanahy fiaraha-miasa tsara izy ary mitondra hery tsara izay manamafy ny dinamikan'ny ekipa. \n Ny iray amin'ireo hevitra vao haingana nentiny dia ny fahalianany amin'ny fivoaran'ny faharanitan-tsaina artifisialy sy ny fampidirany izany mora ao amin'ny asa andavanandro ataon'ny mpamorona, ka manatsara ny fahombiazantsika. \n Ny fahalianany sy ny faniriany hianatra dia mamela azy hivoatra haingana sy handray anjara lehibe amin'ny tetikasa tsirairay. \n Manoro azy aho amin'ny fo manontolo.",
      ...
      "popup_image1title": "Teknolojia PHP 8",
      "popup_image1": "PHP 8 dia ampiasaina ho an'ny fitantanana ny automatisation ny dingana ETL, indrindra amin'ny fanamorana ny fanangonana, ny fanovana ary ny fametrahana angon-drakitra. M thanks to its new features, such as the JIT compiler and named arguments, PHP 8 optimizes the handling of complex data and ensures efficient processing. Ny toetra voatokana sy ny fitantanana henjana ny lesoka dia miantoka ihany koa ny fahamarinan-toerana sy ny fahaiza-manao ny scripts ETL.",

      "popup_image2title": "Teknolojia Laravel 8",
      "popup_image2": "Laravel 8 dia ampiasaina ho toy ny fototra amin'ny fananganana sy ny fitantanana ny dingana ETL, manolotra tontolo iainana matanjaka sy tsara rafitra ho an'ny fanangonana, ny fanovana ary ny fametrahana angon-drakitra. M thanks to its advanced features such as scheduling jobs, queues for managing background tasks, and its powerful Eloquent ORM, Laravel facilitates the management of large volumes of data and ensures efficient and secure processing. Ny framework dia ahafahana manao intégration malama amin'ny rafitra fitehirizana samihafa sy ny angon-drakitra mifamatotra, sady manamora ny fampandrosoana haingana sy azo tantanana noho ny rafitra modular sy scalable.",

      "popup_image3title": "Teknolojia Docker",
      "popup_image3": "Docker dia ampiasaina ho an'ny fanamafisana ny dingana ETL rehetra, manome tontolo iainana voafetra sy mitovy ho an'ny fanangonana, ny fanovana ary ny fametrahana angon-drakitra. Ny singa tsirairay amin'ny rojo ETL (databases, scripts de traitement, fitehirizana) dia voarakitra ao anaty containers, miantoka ny portabilité sy ny reproducibility tonga lafatra eo amin'ny tontolo iainana fananganana, fitsapana ary famokarana. Docker dia manamora ihany koa ny fametrahana sy ny fitantanana ny fiankinan-doha, sady manatsara ny fampiasana loharano noho ny orchestration ny containers, manome antoka ny fanatanterahana malama sy scalable ny pipeline ETL.",

      "popup_image4title": "Jenkins",
      "popup_image4": "Jenkins dia ampiasaina ho an'ny fanamafisana ny fametrahana sy ny intégration continue (CI/CD) ao anatin'ny tetikasa ETL. M thanks to its configurable pipelines, Jenkins allows scheduling and executing tests, builds, and deployments, thus ensuring that the ETL processes are systematically tested and deployed in a controlled environment. Izany dia manome antoka ny famoahana tsy tapaka sy azo antoka ny endri-javatra, miaraka amin'ny fanehoan-kevitra haingana momba ny olana mety hitranga.",

      "popup_image5title": "Bitbucket",
      "popup_image5": "Bitbucket dia miasa ho toy ny sehatra Git ho an'ny fitantanana ny kinova sy ny fiaraha-miasa amin'ny kaody loharano ny tetikasa ETL. Ny fiasa toy ny pull requests sy ny Bitbucket CI pipelines dia ahafahan'ny ekipa manara-maso ny fanovana ny kaody sy manome antoka ny fampandrosoana azo antoka sy mangarahara. Bitbucket dia ahafahana mandray anjara amin'ny fitaovana hafa ao amin'ny ekosistema toy ny Jira sy Confluence, manamora ny fitantanana mahomby ny tetikasa.",

      "popup_image6title": "Linux Debian",
      "popup_image6": "Linux Debian dia ny rafitra fiasana voafidy ho an'ny fitantanana ny infrastrukturam-panjakana ny tetikasa ETL. Fantatra amin'ny fahamarinan-toerany, ny fiarovana ary ny fahaiza-miasa ambony amin'ny teknolojia open-source, Debian dia miantoka tontolo iainana azo antoka ho an'ny fanatanterahana ny containers Docker, manamora ny fitantanana ny dingana ETL, ary manara-maso ny angon-drakitra sy ny serivisy samihafa ilaina.",

      "popup_image7title": "PHPUnit miaraka amin'ny Sail",
      "popup_image7": "PHPUnit dia ampiasaina ho an'ny fanamarinana ny kalitaon'ny kaody ao anatin'ny tetikasa ETL. M thanks to Laravel Sail, which is a local development environment based on Docker, it is easy to set up and run unit tests consistently and in isolation. Izany dia miantoka fa ny singa tsirairay amin'ny ETL dia miasa araka ny nantenaina alohan'ny hametrahana azy amin'ny pipeline lehibe.",

      "popup_image8title": "Atlassian (Fitantanana Tetikasa)",
      "popup_image8": "Atlassian dia ampiasaina ho an'ny fitantanana ny tetikasa ETL, manamora ny fanaraha-maso ny asa, ny fampandrosoana, ny fe-potoana, sy ny tanjona. M thanks to its integration with tools like Jira and Confluence, Atlassian facilitates seamless collaboration between teams, ensuring that every step of the ETL process is well documented, monitored, and completed within the deadlines.",

      "popup_image9title": "Jira",
      "popup_image9": "Jira dia ampiasaina ho an'ny fanaraha-maso ny asa sy ny loza mitranga mifandraika amin'ny fampandrosoana ny pipeline ETL. Ny dingana tsirairay amin'ny dingana, manomboka amin'ny fanangonana hatrany amin'ny fanovana sy ny fametrahana, dia tantanan'ny Jira, ahafahana manara-maso ny asa sy mitantana tsara ny laharam-pahamehana. Ny workflows personnalisés dia manampy amin'ny fanatsarana ny dingana, miaraka amin'ny sprints ho an'ny fitantanana ny cycles de développement.",

      "popup_image10title": "Confluence (Atlassian)",
      "popup_image10": "Confluence dia ampiasaina ho an'ny fanoratana sy ny fiaraha-miasa momba ny tetikasa ETL. Ny ampahany tsirairay amin'ny dingana, manomboka amin'ny antsipirian'ny teknika ka hatramin'ny fanapahan-kevitra ara-drafitra, dia voarakitra ao Confluence, ahafahan'ny ekipa manara-maso sy manara-maso. Ity sehatra afovoany ity dia manamora ihany koa ny fizarana ny fahalalana sy ny fanombanana ny vaovao manan-danja.",
      "popup_image11title": "Metodolojia ETL miaraka amin'ny Laravel",
      "popup_image11": "Ny metodolojia ETL dia miankina amin'ny Laravel ho an'ny fitantanana ny dingana fanangonana, fanovana ary fametrahana. Laravel dia manamora ny fananganana pipelines ETL modular sy extensible, miaraka amin'ny fitantanana mora ny asa voalahatra sy ny queues ho an'ny fanodinana angon-drakitra ao anaty. Ny fiasa tafiditra, toy ny ORM Eloquent, dia manamora ny fanodinana sy ny fanovana ny angon-drakitra alohan'ny hametrahana azy ao anaty tahirin-kevitra afovoany.",

      "popup_image12title": "Famintinana ankapobeny ny ETL",
      ...
      "popup_image13title": "Dashboard graphique de gestion",
      "popup_image13": "Misy tonton-tafo sary avy amin'ny tetikasa mifandray ampidirina mba hanomezana ny fijery momba ny hetsika sy ny antontan'isa, izay entin'ny ETL sy ny angon-drakitra misy. Amin'ity fitaovana ity, afaka manara-maso ny fifanakalozana tsirairay ireo mpampiasa, mijery ny fivezivezen'ny angon-drakitra (indrindra fa ny fanovana), mamantatra ny tsy fahatomombanana na ny vato misakana, ary mahazo fahitana avy hatrany momba ny angon-drakitra efa novaina.",

      "popup_image14title": "Microservice miaraka amin'ny API",
      "popup_image14": "Ireo tetikasa rehetra mifandraika amin'ny ETL dia natao ihany koa ho microservices, izay misaraka tsirairay ireo singa ao amin'ny pipeline ary mifandray amin'ny alàlan'ny API REST. Izany dia manome fahafaha-manaony, modularité, ary fitomboan'ny rafitra. Ny microservice tsirairay dia miandraikitra ny ampahany amin'ny dingana (fakana, fanovana na famoahana) ary azo apetraka sy havaozina tsy miankina, ary miaraka miasa tsy misy olana amin'ny singa hafa amin'ny alàlan'ny API voafaritry ny fenitra.",

      "popup_image15title": "JavaScript ES6 (ECMAScript 6)",
      "popup_image15": "Manatsara ny fitantanana ny lojika eo amin'ny mpanjifa ny JavaScript ES6 amin'ny alalan'ny fanolorana fiasa maoderina toy ny kilasy, modules, promises, ary fanamorana ny syntaxe. Ho an'ity tetikasa ity, manamora ny fanovàna ny DOM, ny fitantanana ny hetsika mpampiasa, ary ny fandefasana fangatahana asynchrone any amin'ny API ny ES6. Ireo fiasa ireo dia manatsara ny fahavitrihana sy ny fanehoan-kevitra amin'ny interface mpampiasa.",

      "popup_image16title": "jQuery",
      "popup_image16": "Manamora ny fifandraisana amin'ny DOM, ny fitantanana ny animation, ny fangatahana AJAX, ary ny fanovàna hetsika ny jQuery. Na dia manolotra safidy nativa aza ny ES6, dia mbola ilaina ny jQuery mba hiantohana ny fifanarahana amin'ny navigateur taloha sy hanamora ny asa sarotra sasany. Ao amin'ity tetikasa ity, azo ampiasaina ny jQuery mba hitantana ny singa mifandraika haingana sy mahomby.",

      "popup_image17title": "Webpack",
      "popup_image17": "Webpack dia module bundler izay manamora ny fitantanana ny fiankinan-doha sy ny fanangonana ny rakitra JavaScript, CSS, sary, ary loharano hafa ao amin'ny tetikasa. Ho an'ny fampiharana SaaS, azo ampiasaina ny Webpack mba hanatsara ny fahombiazana amin'ny fananganana rakitra bundles voaomana sy amin'ny fandefasana ny singa ilaina am-pilaminana, izay manatsara ny fotoana fidirana amin'ny fampiharana.",

      "popup_image18title": "Metronic 8 Dashboard",
      "popup_image18": "Metronic 8 dia tabilao fitantanana mifototra amin'ny Bootstrap, novolavolaina mba ho mora ampidirina amin'ny fampiharana web. Ao amin'ity tetikasa ity, manome fahafahana hamorona interface mpampiasa maoderina sy madio ho an'ny mpampiasa ny Metronic 8, miaraka amin'ny singa efa vonona ho an'ny sary, ny endrika, ary ny tabilao statistika.",

      "popup_image19title": "PHP version 8",
      "popup_image19": "Manolotra fanatsarana lehibe amin'ny lafiny fahombiazana ny PHP 8 noho ny mpanangona JIT (Just-In-Time) azy. Ao anatin'ny tetikasa, manamora ny fanatsarana ny asan'ny backend ny PHP 8 amin'ny fitantanana sy fanodinana ny angon-drakitra, indrindra fa amin'ny asa fikarohana sy fanadihadiana statistika. Ankoatra izany, ny fiasa vaovao toy ny Union Types, Named Arguments, ary Attributes dia manamora ny fanoratana kaody malefaka sy mora vakiana.",

      "popup_image20title": "SSH Server",
      "popup_image20": "SSH (Secure Shell) dia protokola izay mamela ny fitantanana ny lohamilina lavitra amin'ny fomba azo antoka. Ao amin'ity tetikasa ity, ampiasaina ny SSH amin'ny fametrahana, fitantanana, ary fikojakojana ny fampiharana ao amin'ny lohamilina, miantoka ny fiarovana ny fifandraisana sy ny fandefasana angon-drakitra mandritra ny fanavaozana na fanamafisana.",

      "popup_image21title": "SCRUM",
      "popup_image21": "SCRUM dia fomba fanao Agile ampiasaina amin'ny fitantanana tetikasa sarotra, indrindra amin'ny fivoaran'ny rindranasa. Ao amin'ny toe-javatra fanatsarana ny fampiharana SaaS, manampy amin'ny fandaminana sy fananganana ny asa amin'ny fizarana kely antsoina hoe sprints ny SCRUM, izay ahafahana manome haingana ny fiasa azo ampiasaina sy mahazo fanehoan-kevitra matetika avy amin'ny mpampiasa na ireo liana. Manampy amin'ny fiaraha-miasa eo amin'ny ekipa ny SCRUM, miantoka ny fanovana tsy tapaka ary manatsara ny kalitaon'ny vokatra farany.",

      "popup_image22title": "Fikarakarana Backend miaraka amin'ny Laravel",
      "popup_image22": "Laravel dia framework PHP ampiasaina amin'ny fikarakarana backend amin'ny tetikasa. Manolotra rafitra MVC izay manamora ny fampivoarana haingana ny fampiharana web matanjaka izy. Ho an'ity tetikasa ity, manampy amin'ny fananganana fangatahana API, ny fitantanana ny tahiry angon-drakitra, ary ny fametrahana rafitra fanamarinana ny Laravel, miaraka amin'ny fampidirana fiasa toy ny fampandrenesana, ny filaharana (queues), ary ny fitantanana ny mpampiasa.",

      "popup_image23title": "Fiarovana Laravel",
      "popup_image23": "Jetstream sy Breeze no safidy ho an'ny fanamarinana, miaraka amin'ny andraikitra sy fahazoan-dàlana voafaritra amin'ny alàlan'ny politika. Ny fiarovana CSRF dia mavitrika, ny angon-drakitra dia voamarina tsara, ary ny tenimiafina dia avoaka amin'ny bcrypt. Ny rakitra dia voatahiry am-pilaminana, ny angon-drakitra manan-danja dia voaaro, ary misy fiarovana amin'ny fanafihana XSS amin'ny alàlan'ny famotsorana ny angon-drakitra ao amin'ny sary. Misy tatitra momba ny asa ataon'ny mpampiasa, miaraka amin'ny famerana ny fikasana fidirana mba hisorohana ny fanafihana amin'ny alàlan'ny fanerena.",

      "popup_image24title": "Fitantanana Laravel",
      "popup_image24": "Ny kaody dia voalamina amina fomba modular ho an'ny rafitra mazava. Ny fifindra-monina dia ampiasaina ho an'ny angon-drakitra, ary ny mpandahateny mba hanamboarana asa ho azy. Ny fametrahana dia voafehy amin'ny rakitra .env, raha ny fametrahana dia mandeha ho azy amin'ny alàlan'ny pipelines CI/CD. PHPUnit dia ampiasaina ho an'ny fitsapana mandeha ho azy, ary ny cache toy ny Redis na Memcached dia manatsara ny fahombiazan'ny rafitra.",

      "popup_image25title": "Fisehoan'ny Android amin'ny XML",
      "popup_image25": "XML dia ampiasaina hamoronana ny interface utilisateur miaraka amin'ny layouts toy ny ConstraintLayout. Ny app dia manome antoka ny fidirana azo antoka miaraka amin'ny famaritana votoaty, amin'ny fanarahana ny fomba fanao tsara amin'ny fidirana. Ny fitoviana hita maso dia tazonina amin'ny alàlan'ny style sy lohahevitra XML, ary misy animation mba hampivoarana ny interface.",

      "popup_image26title": "Rafitra Orchid (ERP Banky)",
      "popup_image26": "Orchid dia ERP banky, izay ahafahana mitantana kaonty mpanjifa, fifanakalozana, trosa ary famatsiam-bola. Manana andraikitra amin'ny fitantanana ny risika sy ny fanarahana izy io. Ampiasaina ho backend ho an'ny app banky, manome API mba hanitsiana ny angon-drakitra amin'ny fotoana tena izy ary apetraka amin'ny lohamilina matanjaka miaraka amin'ny angon-drakitra tahiry toy ny Oracle na MySQL.",

      "popup_image27title": "Fiteny JAVA ho an'ny Android",
      "popup_image27": "Java dia fiteny fototra ho an'ny fampandrosoana Android, manatsara ny fandaharana mifantoka amin'ny zavatra sy ny fampifangaroana miaraka amin'ny Android SDK. Ny threads dia ampiasaina ho an'ny asa mavesatra, ary ny serivisy an-damosina dia miantoka ny fahamendrehan'ny fampiharana na dia eo aza ny fiatoana. Ny fitantanana ny zava-mitranga amin'ny alàlan'ny BroadcastReceiver dia manatsara ny traikefan'ny mpampiasa.",
  ...
  elements.forEach(element => {
    ...
    if (translations[lang] && translations[lang][key]) {
      if (element.placeholder !== undefined) {
        ...
        // Pour tout autre élément, on change le texte
...
const translationsTyped = {
  ...
  "mg": ["Injeniera", "Mpamorona rindrambaiko", "Mpikirakira kaody"]
};
...
function changeLanguageTyped(lang) {
  // Si une instance de Typed.js existe, la détruire
  if (typed) {
      typed.forEach(instance => instance.destroy()); // Détruire toutes les instances
  }
  
  // Récupérer tous les éléments avec la classe "auto-type"
  const elements = document.querySelectorAll(".auto-type");
  typed = []; // Réinitialiser le tableau des instances

  // Initialiser Typed.js pour chaque élément
  elements.forEach(element => {
      const typedInstance = new Typed(element, {
          strings: translationsTyped[lang], // Utiliser les chaînes selon la langue
          typeSpeed: 150,
          backSpeed: 150,
          loop: true
      });
...
// Relance toutes les animations des éléments auto-type visibles (appelé au chargement et au changement de langue)
function resetTypedAnimations() {
  document.querySelectorAll('.auto-type4, .auto-type5, .auto-type6, .auto-type7').forEach(target => {
      startAnimationForTarget(target);
  });
}
...
// Attache l'observer à chaque élément
...
window.onload = function() {
  applyTranslations('fr'); // Par défaut français
  changeFlag('fr');
  changeLanguageTyped('fr'); // Langue par défaut : anglais
  resetTypedAnimations();
